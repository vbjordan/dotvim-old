...
set shortmess=aoO
badd +19 mydev/by_zip.php
badd +346 .htaccess
badd +16 css/pretty_css_storage/combo-minify.ini
badd +497 include/js/self_service.js
badd +141 q_self_service_add_location.php
badd +43 stemplates/self_service_ads/step_one_build_targets.tpl
badd +6 include/Controllers/BusinessServices/AdPlatform/SSAAjaxController.php
badd +37 include/Controllers/AdPlatform/SSAAjaxController.php
badd +0 ~/svn/common/include/AdPlatform/SelfServiceAdTarget.php
badd +0 ~/svn/common/include/AdPlatform/AdTarget.php
badd +1 include/LocationLookup.php
badd +225 ~/.vim/snippets/php.snippets
badd +185 include/Controllers/TruliaResponse.php
badd +1 css/pretty_css_storage/shared_modules/self_service.css
args mydev/by_zip.php
edit stemplates/self_service_ads/step_one_build_targets.tpl
...
exe '1resize ' . ((&lines * 1 + 26) / 52)
exe '2resize ' . ((&lines * 1 + 26) / 52)
exe '3resize ' . ((&lines * 44 + 26) / 52)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit ~/public_html/cobrand_merge/css/pretty_css_storage/shared_modules/self_service.css
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
wincmd w
argglobal
edit ~/public_html/cobrand_merge/include/js/self_service.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 512 - ((37 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
512
...
exe '2resize ' . ((&lines * 1 + 26) / 52)
exe '3resize ' . ((&lines * 44 + 26) / 52)
tabedit ~/public_html/cobrand_merge/include/LocationLookup.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1136
normal zo
let s:l = 86 - ((48 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
normal! 017l
lcd ~/public_html/cobrand_merge
tabedit ~/svn/common/include/AdPlatform/AdTarget.php
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
exe 'vert 1resize ' . ((&columns * 157 + 118) / 236)
exe '2resize ' . ((&lines * 13 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 157 + 118) / 236)
argglobal
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
...
24
normal zo
let s:l = 318 - ((16 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
318
...
wincmd w
argglobal
edit ~/svn/common/include/AdPlatform/SelfServiceAdTarget.php
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
nnoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
