...
function! s:setupSyntaxHighlighting()
    ...
    if g:NERDChristmasTree
        hi def link treePart Comment
        hi def link treePartFile Comment
        hi def link treeFile Comment
        hi def link treeExecFile Comment
        hi def link treeDirSlash Comment
        hi def link treeClosable Comment
    else
    ...
    hi def link treeDir CursorColumn
    hi def link treeUp Directory
    hi def link treeCWD Statement
    hi def link treeLink Macro
    hi def link treeOpenable Comment
